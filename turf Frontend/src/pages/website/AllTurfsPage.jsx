...
const allTurfs = [
    { id: 1, name: 'SportZone Arena', location: 'Andheri West, Mumbai', city: 'Mumbai', sport: 'Cricket', sports: ['Cricket', 'Football'], rating: 4.8, reviews: 124, price: 1200, amenities: ['Floodlights', 'Parking', 'Washroom', 'Drinking Water'], image: '/images/turf1.png' },
    ...
    { id: 3, name: 'GameVault Center', location: 'Koramangala, Bangalore', city: 'Bangalore', sport: 'Multi-Sport', sports: ['Football', 'Cricket'], rating: 4.9, reviews: 203, price: 1200, amenities: ['Floodlights', 'Parking', 'Washroom', 'Seating', 'Drinking Water'], image: '/images/turf3.png' },
    { id: 4, name: 'ProKick Stadium', location: 'Indiranagar, Bangalore', city: 'Bangalore', sport: 'Football', sports: ['Football'], rating: 4.7, reviews: 156, price: 1400, amenities: ['Floodlights', 'Parking', 'Washroom'], image: '/images/turf4.png' },
    { id: 5, name: 'ProPlay Arena', location: 'Vashi, Navi Mumbai', city: 'Mumbai', sport: 'Football', sports: ['Football'], rating: 4.5, reviews: 84, price: 1000, amenities: ['Floodlights', 'Parking'], image: '/images/turf4.png' },
    ...
    { id: 9, name: 'Skyline Football Turf', location: 'Powai, Mumbai', city: 'Mumbai', sport: 'Football', sports: ['Football'], rating: 4.6, reviews: 92, price: 1400, amenities: ['Floodlights', 'Washroom'], image: '/images/turf6.png' },
    ...
    { id: 13, name: 'Spike Football Turf', location: 'Bhawarkua, Indore', city: 'Indore', sport: 'Football', sports: ['Football'], rating: 4.6, reviews: 52, price: 500, amenities: ['Floodlights', 'Parking', 'Washroom'], image: '/images/turf1.png' },
    { id: 14, name: 'Indore Sports Complex', location: 'LIG Colony, Indore', city: 'Indore', sport: 'Football', sports: ['Football', 'Cricket'], rating: 4.9, reviews: 120, price: 1200, amenities: ['Floodlights', 'Parking', 'Seating', 'Washroom', 'AC'], image: '/images/turf6.png' },
