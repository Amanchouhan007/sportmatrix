...
/* ─── Sidebar width constant (keep in sync with the drawer width) ─── */
...
export default function AllTurfsPage() {
    ...
    /* Lock body scroll only when overlay (mobile) drawer is open */
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white selection:bg-emerald-500/30 overflow-x-clip">
            ...
            {/* ── Filter Sidebar ──
                • Desktop (≥768px): pushes content — fixed, no backdrop
                • Mobile  (<768px) : overlay drawer with backdrop             */}
            <div
                className={`fixed top-[221px] left-[2px] h-[calc(100%-221px)] z-[70] bg-[#080f1e] border-r border-white/10 shadow-[4px_0_40px_rgba(0,0,0,0.7)] flex flex-col transition-transform duration-300 ease-in-out ${drawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col gap-5" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.1) transparent' }}>
            ...
            <div className="relative z-40">
                ...
                <div className="w-full relative border-b border-white/5 bg-[#020617] z-50">
                    <div className="w-full px-6 md:px-8 py-8 sm:pt-28 sm:pb-8 relative z-50">
                ...
                {/* ── Push-content wrapper (desktop only) ──
                    An invisible spacer that matches the sidebar width forces
                    the cards container to shift right without any overlap.
                    On mobile the sidebar stays in overlay mode.               */}
                <div className="flex">

                    {/* Desktop sidebar spacer — zero-height, takes up sidebar width */}
                    {!isMobile && (
                        <div
                            className="shrink-0 hidden md:block"
                            style={{
                                width:      drawerOpen ? `${SIDEBAR_W + 2}px` : '0px',
                    ...
                    <div className="flex-1 min-w-0 px-6 md:px-8 py-6">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-black uppercase tracking-widest text-xs transition-all active:scale-95 border ${
                                    activeFilterCount > 0
