...
const allTurfs = [
    ...
    { id: 16, name: 'Smash Football Arena', location: 'Vijay Nagar, Indore', city: 'Indore', rating: 4.8, price: 400, image: '/images/turf4.png', sports: ['Football'], amenities: ['Wooden Court', 'AC', 'Washroom'], lat: 22.7533, lng: 75.8937 },
    { id: 17, name: 'Urban Football Club', location: 'Bandra, Mumbai', city: 'Mumbai', rating: 4.7, price: 600, image: '/images/turf5.png', sports: ['Football'], amenities: ['Floodlights', 'Parking'], lat: 19.0596, lng: 72.8295 },
    { id: 18, name: 'Hoops Football Court', location: 'Koramangala, Bangalore', city: 'Bangalore', rating: 4.9, price: 800, image: '/images/turf6.png', sports: ['Football'], amenities: ['Floodlights', 'Seating', 'Drinking Water'], lat: 12.9352, lng: 77.6245 },
    { id: 19, name: 'Ace Cricket Academy', location: 'Baner, Pune', city: 'Pune', rating: 4.6, price: 1000, image: '/images/turf7.png', sports: ['Cricket'], amenities: ['Clay Court', 'Parking', 'Washroom'], lat: 18.5590, lng: 73.7868 },
    { id: 20, name: 'Street Box Cricket', location: 'Palasia, Indore', city: 'Indore', rating: 4.5, price: 700, image: '/images/turf1.png', sports: ['Box Cricket'], amenities: ['Turf', 'Floodlights'], lat: 22.7244, lng: 75.8839 },
    { id: 21, name: 'Spike Cricket Court', location: 'Adyar, Chennai', city: 'Chennai', rating: 4.7, price: 500, image: '/images/turf2.png', sports: ['Cricket'], amenities: ['Sand Court', 'Washroom'], lat: 13.0012, lng: 80.2565 },
]
