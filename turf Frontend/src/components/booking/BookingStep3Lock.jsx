...
export default function BookingStep3Lock({
    ...
    return (
        <div className="bg-white border border-[#E5E7EB] rounded-3xl p-6 sm:p-8 shadow-sm space-y-7 animate-in fade-in duration-200">
            <div>
                <h2 className="text-xl sm:text-2xl font-black text-[#111827] tracking-tight">Review match details & lock slot</h2>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Double check your match timing and complete instant payment to hold slot</p>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200 space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-black text-[#111827]">{selectedDateObj.formattedLabel} · {slotTimeLabel} ({durationHours} Hr)</span>
                </div>
